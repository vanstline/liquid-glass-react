...
export default function App() {
  ...
  return (
    <div className="grid grid-cols-1 grid-rows-2 md:grid-rows-1 md:grid-cols-3 shadow-2xl w-full max-w-5xl mx-auto md:my-10 h-screen md:max-h-[calc(100vh-5rem)] md:rounded-3xl overflow-hidden font-sans">
      ...
      >
        <div className="w-full min-h-[200vh] absolute top-0 left-0 pb-96 mb-96">
          ...
          <div className="flex flex-col gap-2" id="bright-section">
            ...
            <p className="px-10">
              这是一段示例文本，用于展示液体玻璃效果在文本内容上的视觉表现。
              <br />
      ...
      <div className="row-start-2 rounded-t-3xl md:rounded-none md:col-start-3 bg-gray-900/80 h-full overflow-y-auto backdrop-blur-md border-l border-white/10 p-8 flex flex-col">
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <a
              href="https://github.com/rdev/liquid-glass-react17"
              target="_blank"
          ...
          <p className="text-white/60 text-sm">
            React 液体玻璃容器效果组件。支持丰富的设置和视觉效果。
          </p>

          <p className="font-semibold text-yellow-300 text-xs mt-2 leading-snug">
            ⚠️ 该效果在 Safari 和 Firefox 中不完全生效。在非 Chromium
            内核浏览器中您将看不到边缘折射效果。
          </p>
        </div>
              ...
              <div>
                ...
                <div className="flex items-center space-x-3">
                  <input
                    type="checkbox"
                    id="userInfoDark"
                    checked={userInfoDark}
                    onChange={(e) => setUserInfoDark(e.target.checked)}
                    className="w-5 h-5 accent-blue-500"
                  />
                  <label
                    htmlFor="userInfoDark"
              ...
              <div>
                ...
                <div className="mb-2">
                  <span className="text-xl font-mono text-pink-300">
                    {cornerRadius === 999 ? "最大" : `${cornerRadius}px`}
                  </span>
                </div>
                <input
                  type="range"
              ...
              <div>
                ...
                <div className="flex items-center space-x-3">
                  <input
                    ...
                    id="logoutDark"
                    checked={logoutDark}
                    onChange={(e) => setLogoutDark(e.target.checked)}
                    className="w-5 h-5 accent-blue-500"
                  />
